...
// SQLStore provides all fucntions to execute SQL queries and transaction
...
// It creates a transfer record, add account entries, and update accounts' balance within a single database connection
