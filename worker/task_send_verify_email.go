...
func (processor *RedisTaskProcessor) ProcessTaskSendVerifyEmail(
	...
	if err != nil {
		// We can also decide to skip retries
	...
	verifUrl := fmt.Sprintf("http://localhost:8080/v1/verify_email?email_id=%d&secret_code=%s", verifyEmail.ID, verifyEmail.SecretCode)
	content := fmt.Sprintf(`Hello %s,</br>
	Thank you for registering with us!</br>
	Please <a href="%s">Click here</a> to verify your email address.</br>
	`, user.FullName, verifUrl)
